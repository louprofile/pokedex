...
*/
    ...
    const trocadeimagemdobotao = document.querySelector(".imagem-botao")
    ...
    botaoalterartema.addEventListener("click", () => {
        ...
        if (modoescuroestaAtivo) {
            ...
            trocadeimagemdobotao.setAttribute("src", "./src/imagens/sun.png");
        } else {
           
            body.classList.add("modo-escuro");

            trocadeimagemdobotao.setAttribute("src", "./src/imagens/moon.png");
        }
